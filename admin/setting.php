                ...
                <div class="card">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" name="email" placeholder="contoh : admin@site.com" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['sidebar']) && $_GET['sidebar'] == "setting"  ? $rowEdt['email'] :  (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['email'] : '') ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="tlpn" placeholder="Masukkan No Telepon Anda" required value="<?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['sidebar']) && $_GET['sidebar'] == "setting" ? $rowEdt['tlpn'] :  (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['tlpn'] : '') ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="alamat" id=""><?php echo isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['sidebar']) && $_GET['sidebar'] == "setting"  ? $rowEdt['alamat'] :  (isset($_GET['ubah']) && $_GET['ubah'] == "berhasil" ? $rowEdt['alamat'] : '') ?></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                          <div class="col-sm-2">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-2 offset-md-2">
                                ...
                                if(isset($_GET['tambah']) && $_GET['tambah'] == "berhasil" || isset($_GET['ubah']) && $_GET['ubah'] == "berhasil") {
                                  ?>
                                <a onclick="return confirm('Yakin ingin menghapus?')" href="setting.php?idDel=<?=  $rowEdt['id'] ?>" class="btn btn-danger"> DELETE </a>
                                <?php
                                }
                                ?>
                            </div>

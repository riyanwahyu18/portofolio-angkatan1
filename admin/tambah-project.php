...
if (isset($_POST['simpan'])){
    ...
    if ($foto['error'] == 0) {
      ...
      if ($insert) {
          header("Location:project.php?kirim=sukses");    //pindah ke project.php
      } else {
          header("Location:tambah-project.php?tambah=erorr"); //tetap di tambah-project.php
      }
    }
}
                ...
                <div class="card">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <input class="form-control" name="nama"  type="text" value="<?= isset($_GET['edit']) ? $row['nama'] : '' ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <input class="form-control" type="text" value="<?= isset($_GET['edit']) ? $row['kategori'] : '' ?>" name="kategori">
                            </div>
                        </div>

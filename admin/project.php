...
if (isset($_GET['delete'])) {
    ...
    $delete = mysqli_query($conn, "DELETE FROM project WHERE id = $id"); //Insert, Delete, Update, Select pakai query
    if ($delete) {
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title text-center">Data Project</h5>
                    <div class="table table-responsive">
                        <div class="d-flex justify-content-end mb-2">
                          <a class="btn btn-primary mb-2" href="tambah-project.php">Tambah Project</a>
                        </div>

...
if (isset($_GET['idDel'])) {
    ...
    $delete = mysqli_query($conn, "DELETE FROM resume WHERE id = $id"); //Insert, Delete, Update, Select pakai query
    if ($delete) {
                          ...
                          <tr>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row['deskripsi']?></td>
                                    <td>
                                    <a href="add_edit_resume.php?idEdit=<?= $row['id']?>" class="btn btn-success">Edit</a>
                                    <a href="print-pdf.php?idPrint=<?php echo $row['id']?>" target="_blank" class="btn btn-primary">Print PDF</a>
                                    <a href="resume.php?idDel=<?= $row['id'] ?>" onclick="confirm('Yakin Mau Hapus Bro?')" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>    
                            <?php 
                            }

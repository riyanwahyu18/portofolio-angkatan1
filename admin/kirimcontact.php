...
if(isset($_POST['kirim'])){
  ...
  $header = "From: riyan.profesional@gmail.com" . "\r\n".
            "Reply-To: riyan.profesional@gmail.com" . "\r\n".
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                    <h5 class="card-title"> Balas Pesan</h5>
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <div class="col-sm-2">
                                <pre>Nama   : <?= $row ['nama'] ?></pre>
                                <pre>Email  : <?= $row ['email'] ?></pre>
                                <pre>subjek : <?= $row ['subjek'] ?></pre>
                                <pre>pesan  : <?= $row ['pesan'] ?></pre>
                            </div>
                        </div>
